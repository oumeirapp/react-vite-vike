Generated with [vike.dev/new](https://vike.dev/new) ([version 628](https://www.npmjs.com/package/create-vike/v/0.0.628)) using this command:

```sh
npm create vike@latest --- --react --tailwindcss --shadcn-ui --eslint --shadcnUi
```
